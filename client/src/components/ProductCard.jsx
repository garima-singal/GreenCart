...
//                             <button className="flex items-center justify-center gap-1 bg-indigo-100 border border-indigo-300 md:w-20 w-16 h-[34px] rounded text-indigo-600 font-medium" onClick={() => setCount(1)} >
...
//           onClick={() => navigate(`/product/${product._id}`)} // navigate to product details (optional)
//         >
//           <img
    ...
    <div className="border border-gray-500/20 rounded-md md:px-4 px-3 py-2 bg-white min-w-56 max-w-56 w-full">
      ...
      <div className="text-gray-500/60 text-sm">
        ...
        <div className="flex items-end justify-between mt-3">
          ...
          {/* ✅ Updated Section */}
          <div className="text-[#4fbf8b]" onClick={(e)=>{e.stopPropogation(); }}>
            {quantity === 0 ? (
              // Add button
              <button
                className="flex items-center justify-center gap-1 bg-[#44ae7c]/10 border border-[#44ae7c]md:w-20 w-16 h-[34px] rounded text-[#44ae7c] font-medium"
                onClick={() => addToCart(product)}
              >
                <img src={assets.cart_icon} alt="Cart" />
                Add
