...
const ProductDetails = () => {
  ...
  return (
    <div className="mt-12">
      ...
      <button onClick={()=>{navigate('/products');scrollTo(0,0)}} className="mx-auto cursor-pointer px-12 my-16 py-2.5 border rounded text-[#4fbf8b] hover:bg-[#4fbf8b]/10 transition">
          See More
      </button>
      </div>
    </div>
